...
final class WordPressAssetUploadPipelineHookRegistrar
{
    ...
    public function __construct(
        private readonly AssetUploadPipelineCoordinator $coordinator,
        callable $addFilter,
    ) {
    ...
    {
        ($this->addFilter)($hook, [$this->coordinator, 'process'], $priority);
    }
}
